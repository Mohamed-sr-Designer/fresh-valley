/* =====================================================================
   ...
   Inline markup allowed in text settings:
     *word*  → light italic accent      ~word~ → same (legacy underline)
     line breaks → <br>
   Image references: product slug ("mango"), "banner:packaging",
   "hero", or any URL / uploaded file.
   ===================================================================== */
window.FVTheme = (function () {
  ...
  const DEFAULTS = {
    ...
    settings: {
      ...
      tagline: "Grown in Egypt · graded by hand · Cairo",
      announcement: { enabled: true, text: "Order before 6pm for next-day delivery across Cairo · complimentary over EGP 600", link: "products.html", link_label: "Shop the harvest" },
      nav: [
      ...
      footer: {
        ...
        blurb: "Fruit, vegetables and herbs from Egypt's quietest fields — chosen at first light, graded by hand, and at your door the next day.",
        columns: [
          { title: "Shop", links: [
            { label: "All produce", href: "products.html" },
            { label: "Boxes", href: "products.html?cat=boxes" },
            { label: "In season", href: "products.html?cat=seasonal" },
            { label: "Herbs", href: "products.html?cat=herbs" },
            { label: "Organic Reserve", href: "products.html?cat=organic-reserve" } ] },
          { title: "The house", links: [
            { label: "Our story", href: "about.html" },
            { label: "The Art of Hosting", href: "hosting.html" },
            { label: "Field Notes", href: "journal.html" },
            { label: "How we grade", href: "about.html#quality" } ] },
          { title: "Care", links: [
    ...
    pages: {
      ...
      index: { title: "Home", sections: [
        { id: "hero", type: "hero", settings: {
          almanac: true, eyebrow: "Picked at first light",
          title: "Fresh from\nthe valley,\nto your *table*.",
          lede: "Fruit, vegetables and herbs from Egypt's quietest fields — chosen at first light, cooled within hours, and at your door tomorrow.",
          cta1_label: "Shop the harvest", cta1_link: "products.html",
          cta2_label: "Build a hosting box", cta2_link: "products.html?cat=boxes",
          image: "hero", image_alt: "A host setting export-grade fruit on a marble table in morning light",
          caption: "The morning table · New Cairo", peak: true,
        } },
        { id: "intro", type: "statement", settings: {
          eyebrow: "Our way",
          text: "Fresh Valley began in the fields, not in a shop. We work beside the growers of Qalyubia, Ismailia, Beheira and Siwa, keep only what would pass for *export*, and carry it to Cairo within a day of leaving the ground.",
          sign: "The growers, graders and drivers of Fresh Valley", cta_label: "Read our story", cta_link: "about.html", band: "paper" } },
        { id: "categories", type: "categories", settings: { eyebrow: "The market", title: "Walk the *rows*.", text: "Six ways into the season — every piece chosen by hand, every one with a place it came from.", cta_label: "See everything", cta_link: "products.html" }, blocks: [
          ...
          { type: "tile", settings: { title: "Herbs", text: "Cut the morning they leave", image: "", link: "products.html?cat=herbs", count: "herbs" } },
          { type: "tile", settings: { title: "Hosting boxes", text: "Composed, wrapped, ready to give", image: "banner:door-delivery", link: "products.html?cat=boxes", count: "boxes" } },
          { type: "tile", settings: { title: "In season", text: "Only while it is at its best", image: "mango", link: "products.html?cat=seasonal", count: "seasonal" } },
          { type: "tile", settings: { title: "Organic reserve", text: "Our quietest, rarest lots", image: "medjool-dates", link: "products.html?cat=organic-reserve", count: "organic-reserve" } },
        ] },
        { id: "season", type: "product_rail", settings: { eyebrow: "At its peak", title: "In the fields *this week*.", text: "A changing selection, offered only while it is truly at its best.", collection: "now", limit: 10, cta_label: "Shop the season", cta_link: "products.html?cat=seasonal", band: "paper" } },
        { id: "almanac", type: "almanac", settings: { eyebrow: "The Valley Almanac", title: "What the land gives, *month by month*.", text: "Most of what we grow has a season. We wait for it — the shaded month is where we are now.", limit: 10, band: "mist" } },
        { id: "story", type: "story", settings: {
          eyebrow: "The Art of Hosting", title: "Arrive with the *season*.",
          text: "No one visits empty-handed. We make what you carry unforgettable — a box of what is ripe right now, graded and wrapped by hand, set on the table the moment you walk in.",
          struck: "", image: "banner:door-delivery",
          cta_label: "Gift a hosting box", cta_link: "product.html?box=hosting-box", cta2_label: "The full ritual", cta2_link: "hosting.html" }, blocks: [
          { type: "step", settings: { title: "Choose your box", text: "Fruit, vegetables, or both — sized for four guests or sixteen.", image: "" } },
          { type: "step", settings: { title: "We grade, arrange and wrap", text: "Every piece chosen by hand and composed like a still life.", image: "" } },
          { type: "step", settings: { title: "You arrive generous", text: "Delivered next-day, cold and ready to set down. They remember it.", image: "" } },
        ] },
        { id: "boxes", type: "boxes", settings: { eyebrow: "Curated", title: "Boxes, composed like a *still life*.", text: "Graded to export standard and wrapped to arrive looking like the gift it is.", boxes: "hosting-box,premium-fruit-box,family-box,organic-reserve-box", cta_label: "All boxes", cta_link: "products.html?cat=boxes", band: "paper" } },
        { id: "origins", type: "origins", settings: { eyebrow: "Provenance", title: "Where it *grows*.", text: "From the Delta to the Western Desert. Every piece we sell carries the name of the place it came from.", band: "paper" } },
        { id: "quality", type: "image_text", settings: {
          ...
          image: "banner:staff-shirt", chip: "Graded by hand in Cairo", cta_label: "How we grade", cta_link: "about.html#quality", flip: false, band: "mist" } },
        { id: "facts", type: "stats", settings: { eyebrow: "In numbers", title: "A small house.\n*Serious standards.*", band: "dark" }, blocks: [
          { type: "stat", settings: { value: "24", decimals: 0, suffix: "h", label: "From the grading table to your door" } },
          { type: "stat", settings: { value: "8", decimals: 0, suffix: "", label: "Growing regions, Delta to oasis" } },
          { type: "stat", settings: { value: "5", decimals: 0, suffix: "", label: "Districts served next-day" } },
          { type: "stat", settings: { value: "4", decimals: 0, suffix: "", label: "Checks every piece must pass" } },
        ] },
        { id: "delivery", type: "banner", settings: { eyebrow: "Next-day across five districts", title: "Set a better table, *tomorrow*.", text: "New Cairo · Sheikh Zayed · October · Madinaty · Rehab. Order before 6pm and it arrives cold, graded and ready.", image: "banner:delivery-van", cta_label: "Start your basket", cta_link: "products.html", cta2_label: "Delivery areas", cta2_link: "contact.html#areas" } },
        { id: "journal", type: "journal", settings: { eyebrow: "Field notes", title: "Notes from the *valley*.", limit: 3, layout: "grid", cta_label: "All field notes", cta_link: "journal.html" } },
      ] },
      ...
      hosting: { title: "The Art of Hosting", sections: [
        ...
        { id: "ritual", type: "hscroll", settings: { eyebrow: "The ritual", title: "From our hands to *their table*.", text: "Six quiet steps between the orchard and the moment you walk in.", band: "dark" }, blocks: [
          ...
          { type: "card", settings: { title: "We wrap", text: "Paper, ribbon, a written card.", image: "banner:staff-shirt" } },
        ...
        { id: "collection", type: "boxes", settings: { eyebrow: "The collection", title: "Five ways to be *remembered*.", text: "Each box is composed like a still life, graded to export standard, and wrapped to arrive looking like the gift it is.", boxes: "hosting-box,premium-fruit-box,family-box,seasonal-box,organic-reserve-box", cta_label: "", cta_link: "", band: "paper" } },
        { id: "difference", type: "compare", settings: { eyebrow: "The difference", title: "Why a box, and not a *bouquet*.", old_title: "The usual gift", old_items: "Looks nice for an evening, then it's gone.|The same thing everyone brings.|Decorative — admired, rarely used.|Could have been bought any day.", new_title: "A Fresh Valley box", new_items: "It gets eaten, shared, enjoyed — not just admired.|It's seasonal. It could only have come now.|It's generous — enough for the whole table.|Graded, arranged and wrapped by hand.|The gesture outlives the evening.", band: "mist" } },
        { id: "details", type: "image_text", settings: { eyebrow: "The details", title: "It's the small things they *notice*.", text: "", list: "Our own paper — every box wrapped by hand, never a plastic bag|The seasonal ribbon — tied in Mid Forest or Charcoal, a quiet signal of the season|A handwritten card — your words, written by hand, not a printed sticker|Composed, not packed — arranged like a still life, beautiful the moment it opens", image: "banner:door-delivery", chip: "Mid Forest · Charcoal", cta_label: "", cta_link: "", flip: true, band: "paper" } },
        ...
        { id: "begin", type: "cta", settings: { eyebrow: "Begin", title: "Be the guest they *remember*.", text: "Choose a box, add a few words, and we'll do the rest — graded, arranged, wrapped and delivered ready for the table.", cta_label: "Gift a hosting box", cta_link: "product.html?box=hosting-box", cta2_label: "See all boxes", cta2_link: "products.html?cat=boxes", style: "mist" } },
      ] },

      /* ============================ ABOUT ============================ */
      about: { title: "About", sections: [
        { id: "head", type: "page_head", settings: { eyebrow: "Our story", title: "Produce, treated with the care it *deserves*.", text: "Fresh Valley is a small produce house. We work directly with Egypt's finest growers — the same farms that supply Europe's best tables — and keep the best of their harvest here, for homes in Cairo.", cta_label: "Browse the harvest", cta_link: "products.html", cta2_label: "", cta2_link: "", image: "banner:staff-shirt", caption: "Graded by hand in Cairo." } },
        { id: "story", type: "image_text", settings: { eyebrow: "Where it began", title: "We wanted to keep some of the best *here*.", text: "We started Fresh Valley with a simple frustration: the best of Egypt's produce was leaving the country, while the rest filled the shelves at home.\n\nSo we went to the fields ourselves. We choose that produce at first light, then shape it into boxes and collections for the way people host today: generously, beautifully, and without a fuss. An everyday purchase, raised to the standard of an occasion.\n\nWe are based in Cairo, and we deliver to the neighbourhoods we know best — carefully, on time, and in packaging worth keeping.", list: "", image: "banner:delivery-van", chip: "Cairo, Egypt", cta_label: "", cta_link: "", flip: false, band: "paper" } },
        { id: "quality", type: "steps", settings: { eyebrow: "Behind the quality", title: "Graded like an export *house*.", text: "Nothing reaches your table by accident. Every piece of produce passes through the same four steps the export market demands.", band: "mist" }, blocks: [
        ...
        { id: "origins", type: "origins", settings: { eyebrow: "Our growers", title: "Eight regions, one *standard*.", text: "We know every field by name. These are the places our produce comes from this year.", band: "paper" } },
        { id: "numbers", type: "stats", settings: { eyebrow: "By the numbers", title: "Small company.\n*Serious standards.*", band: "dark" }, blocks: [
          { type: "stat", settings: { value: "100", decimals: 0, suffix: "%", label: "Export-grade selection" } },
          { type: "stat", settings: { value: "24", decimals: 0, suffix: "h", label: "Harvest to your door" } },
          { type: "stat", settings: { value: "8", decimals: 0, suffix: "", label: "Growing regions" } },
          { type: "stat", settings: { value: "5", decimals: 0, suffix: "", label: "Districts served" } },
        ] },
        ...
        { id: "areas", type: "areas", settings: { eyebrow: "Where we deliver", title: "Close to home, by *design*.", text: "We deliver to the communities we know best — so we can keep the cold chain short and the service personal. Complimentary delivery on orders over EGP 600.", note: "More areas soon.", image: "banner:home-delivery", band: "mist" } },
        { id: "taste", type: "banner", settings: { eyebrow: "Taste it for yourself", title: "Taste the difference *grading* makes.", text: "Start with what is in season, or let us choose for you with a curated box.", image: "banner:door-delivery", cta_label: "Browse the harvest", cta_link: "products.html", cta2_label: "The Art of Hosting", cta2_link: "hosting.html" } },
      ] },

      /* ============================ CONTACT ============================ */
      contact: { title: "Contact", sections: [
        { id: "head", type: "page_head", settings: { eyebrow: "We're glad to help", title: "Talk to Fresh *Valley*.", text: "A question about an order, a hosting idea, or a wholesale enquiry — we read everything, and we reply like people.", cta_label: "", cta_link: "", cta2_label: "", cta2_link: "", image: "", caption: "" } },
        { id: "form", type: "contact", settings: { eyebrow: "Write to us", title: "Send a *message*", subjects: "An order|A product question|Hosting & events|Corporate & events|Wholesale & partnerships|Something else", note: "We usually reply within one working day.", band: "paper" } },
        { id: "areas", type: "areas", settings: { eyebrow: "Where we deliver", title: "Delivery *areas*", text: "We keep our delivery close to home, so the cold chain stays short and the service stays personal. Complimentary delivery on orders over EGP 600; a flat EGP 45 below that.", note: "Outside these areas? Tell us where you are — we're expanding.", image: "banner:delivery-van", band: "mist" } },
        { id: "faq", type: "faq", settings: { eyebrow: "Good to know", title: "Common *questions*", text: "Still wondering? Message us on WhatsApp — it's the fastest way to a real person.", band: "paper" }, blocks: [
          ...
          { type: "qa", settings: { q: "Can I choose what goes in a box?", a: "Box contents follow the season, so we compose them for you around what is at its peak. If there's something you'd rather avoid, add a note at checkout and we'll work around it." } },
      ...
      /* ============================ JOURNAL ============================ */
      journal: { title: "Field Notes", sections: [
        { id: "head", type: "page_head", settings: { eyebrow: "Read, cook, host", title: "Field *notes*.", text: "Recipes, hosting ideas and a little produce education — written between the fields and the table.", cta_label: "", cta_link: "", cta2_label: "", cta2_link: "", image: "", caption: "" } },
        { id: "list", type: "journal", settings: { eyebrow: "All notes", title: "More from the *valley*", limit: 0, layout: "magazine", cta_label: "", cta_link: "" } },
        { id: "shop", type: "product_rail", settings: { eyebrow: "Cook along", title: "Straight from the *stories*", text: "", collection: "hosting", limit: 10, cta_label: "Shop the harvest", cta_link: "products.html", band: "mist" } },
      ] },

      /* ============================ POLICIES ============================ */
      policies: { title: "Company Policies", sections: [
        { id: "head", type: "page_head", settings: { eyebrow: "The promises behind the produce", title: "Company *policies*", text: "Plain words about freshness, delivery, returns, payment and your privacy.", cta_label: "", cta_link: "", cta2_label: "", cta2_link: "", image: "", caption: "", compact: true } },
        { id: "body", type: "legal", settings: { updated: "Last updated: September 2026" }, blocks: [
          ...
          { type: "clause", settings: { title: "Privacy", body: "We collect only what we need to deliver your order well: your name, contact details, address and order history. We use it to serve you and to send the order updates you need.\n\nWe do not sell your data. You can ask us to update or delete your information at any time by writing to hello@freshvalley.eg. For the full detail, see our Terms of Use." } },
      ...
      terms: { title: "Terms of Use", sections: [
        { id: "head", type: "page_head", settings: { eyebrow: "The fine print, kept plain", title: "Terms of *use*", text: "The agreement between you and Fresh Valley when you browse, order and manage your account.", cta_label: "", cta_link: "", cta2_label: "", cta2_link: "", image: "", caption: "", compact: true } },
  ...
  function merge(base, over) {
    ...
    // Layouts saved before the v5 redesign are ignored so the new pages show.
    if (over.pages && (over.version || 0) >= 5) Object.keys(over.pages).forEach((k) => { if (over.pages[k] && Array.isArray(over.pages[k].sections)) out.pages[k] = over.pages[k]; });
